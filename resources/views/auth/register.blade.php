...
<div class="container mx-auto max-w-screen-md">
    <div class="flex flex-wrap justify-center">
                ...
                <div class="flex flex-col break-words bg-white border border-2 shadow-md mt-10"> 
                    ...
                    <form method="POST" action="{{ route('register') }}" class="py-10 px-5" novalidate>
                              ...
                              <div class="flex flex-wrap mb-6">
                                      ...
                                      <button type="submit" class="bg-gray-500 w-full hover:bg-gray-700 text-gray-100 p-2 
        ...
        <div class="md:w-1/2 order-1 md:order-2 px-10 text-center flex flex-col justify-center">
            <div class="text-indigo-500 text-3xl"> Eres reclutador? </div>
